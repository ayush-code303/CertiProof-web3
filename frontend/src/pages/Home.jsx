        ...
        <div className="min-h-screen bg-dark-950">
            ...
            <header className="border-b border-dark-800">
                <div className="container mx-auto px-4 py-4 flex justify-between items-center">
                    <div className="flex items-center gap-3">
                        ...
                        <h1 className="text-2xl font-bold gradient-text">CertiProof</h1>
                    </div>
            ...
            <section className="container mx-auto px-4 py-20">
                <div className="max-w-4xl mx-auto text-center">
                    ...
                    <h2 className="text-5xl md:text-7xl font-extrabold mb-8 tracking-tight leading-tight text-white">
                        Decentralized Certificate
                        <br />
                        <span className="gradient-text animate-pulse-slow inline-block">Validation System</span>
                    </h2>
            ...
            <section className="container mx-auto px-4 py-24 relative z-10">
                <div className="absolute inset-0 bg-gradient-premium opacity-5 blur-3xl pointer-events-none rounded-full transform -translate-y-1/2 scale-150"></div>
                
                <div className="grid md:grid-cols-3 gap-8 relative z-20">
                    <div className="card-hover text-center group">
                        <div className="w-20 h-20 bg-gradient-to-br from-primary-500 to-accent-600 rounded-2xl flex items-center justify-center mx-auto mb-6 glow transform group-hover:scale-110 transition-transform duration-500 animate-float">
                            <svg className="w-10 h-10 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 15v2m-6 4h12a2 2 0 002-2v-6a2 2 0 00-2-2H6a2 2 0 00-2 2v6a2 2 0 002 2zm10-10V7a4 4 0 00-8 0v4h8z" />
                            </svg>
                        </div>
                        <h3 className="text-2xl font-bold mb-3 text-white group-hover:text-primary-400 transition-colors">Tamper-Proof</h3>
                    ...
                    <div className="card-hover text-center group">
                        <div className="w-20 h-20 bg-gradient-to-br from-green-400 to-emerald-600 rounded-2xl flex items-center justify-center mx-auto mb-6 glow-green transform group-hover:scale-110 transition-transform duration-500 animate-float" style={{ animationDelay: '0.5s' }}>
                            <svg className="w-10 h-10 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z" />
                            </svg>
                        </div>
                        <h3 className="text-2xl font-bold mb-3 text-white group-hover:text-green-400 transition-colors">Encrypted Storage</h3>
                        <p className="text-gray-400 font-light leading-relaxed">
                    ...
                    <div className="card-hover text-center group">
                        <div className="w-20 h-20 bg-gradient-to-br from-purple-500 to-purple-700 rounded-2xl flex items-center justify-center mx-auto mb-6 glow transform group-hover:scale-110 transition-transform duration-500 animate-float" style={{ animationDelay: '1s' }}>
                            <svg className="w-10 h-10 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 10V3L4 14h7v7l9-11h-7z" />
                            </svg>
                        </div>
                        <h3 className="text-2xl font-bold mb-3 text-white group-hover:text-purple-400 transition-colors">Instant Verification</h3>
                        <p className="text-gray-400 font-light leading-relaxed">
            ...
            <footer className="border-t border-dark-800 mt-20">
                <div className="container mx-auto px-4 py-8 text-center text-gray-500">
                    <p className="mb-2">© CertiProof. Powered by Ethereum, IPFS, and Web3.</p>
                    <a href="https://github.com/ayush-code303" target="_blank" rel="noopener noreferrer" className="text-primary-400 hover:text-primary-300 font-medium transition-colors">
                        Built by @ayush-code303
                    </a>
                </div>
            </footer>
        </div>
